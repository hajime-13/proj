<x-app-layout>
    <x-slot name="header">
        <h2 class="fw-semibold fs-5 mb-0">✏️ Edit Order</h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('orders.update', $order) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="customer_name" class="form-control @error('customer_name') is-invalid @enderror"
                                   value="{{ old('customer_name', $order->customer_name) }}" placeholder="Optional">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="quantity" class="form-control @error('quantity') is-invalid @enderror"
                                       min="1" value="{{ old('quantity', $order->quantity) }}" required>
                                @error('quantity')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Price (₱) <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="price" class="form-control @error('price') is-invalid @enderror"
                                       min="0" value="{{ old('price', $order->price) }}" required>
